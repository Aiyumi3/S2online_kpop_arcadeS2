...
class KPopGame extends Phaser.Scene {
	...
	this.physics.add.collider(player, fly, upWay, null, this);
        ...
        heartsText = this.add.text(725, 255, '💚: 24', { fontSize: '9pt', fill: '#c6f50c', fontFamily:'Lemon',
        ...
        scoreText = this.add.text(437, 255, 'score: 0', { fontSize: '9pt', fill: '#c6f50c', fontFamily:'Lemon',
            stroke: 'rgba(194,86,222,0.94)', strokeThickness: 3});
